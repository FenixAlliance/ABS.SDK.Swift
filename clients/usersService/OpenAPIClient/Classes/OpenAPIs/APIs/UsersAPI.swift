...
open class UsersAPI {
     ...
     */
    @discardableResult
    open class func getCurrentUserEnrollmentsAsync(apiVersion: String? = nil, xApiVersion: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: TenantEnrollmentDtoListEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    open class func getCurrentUserEnrollmentsAsyncWithRequestBuilder(apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<TenantEnrollmentDtoListEnvelope> {
     ...
     */
    @discardableResult
    open class func getCurrentUserEnrollmentsExtendedAsync(apiVersion: String? = nil, xApiVersion: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ExtendedTenantEnrollmentDtoListEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - parameter apiVersion: (query)  (optional)
     - parameter xApiVersion: (header)  (optional)
     - returns: RequestBuilder<ExtendedTenantEnrollmentDtoListEnvelope> 
     */
    open class func getCurrentUserEnrollmentsExtendedAsyncWithRequestBuilder(apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<ExtendedTenantEnrollmentDtoListEnvelope> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ExtendedTenantEnrollmentDtoListEnvelope>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     Get the tenants that the current user is enrolled in
     - GET /api/v2/Me/Tenants/Extended
     - Get the tenants that the current user is enrolled in
     - parameter apiVersion: (query)  (optional)
     - parameter xApiVersion: (header)  (optional)
    ...
    open class func getCurrentUserTenantsExtendedAsyncWithRequestBuilder(apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<ExtendedTenantDtoListEnvelope> {
        let localVariablePath = "/api/v2/Me/Tenants/Extended"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters: [String: Any]? = nil
     ...
     */
    @discardableResult
    open class func getEnrollmentAsync(enrollmentId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: TenantEnrollmentDtoEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getEnrollmentAsyncWithRequestBuilder(enrollmentId: enrollmentId, apiVersion: apiVersion, xApiVersion: xApiVersion).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getEnrollmentAsyncWithRequestBuilder(enrollmentId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<TenantEnrollmentDtoEnvelope> {
