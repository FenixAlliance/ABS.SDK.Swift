...
open class SupportTicketPrioritiesAPI {
    ...
    /**
     ...
     - parameter apiVersion: (query)  (optional)
     - parameter xApiVersion: (header)  (optional)
     - parameter supportTicketPriorityDtoCollectionQueryParameters: (body)  (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func getSupportTicketPrioritiesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, supportTicketPriorityDtoCollectionQueryParameters: SupportTicketPriorityDtoCollectionQueryParameters? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: SupportTicketPriorityDtoListEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getSupportTicketPrioritiesAsyncWithRequestBuilder(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, supportTicketPriorityDtoCollectionQueryParameters: supportTicketPriorityDtoCollectionQueryParameters).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getSupportTicketPrioritiesAsyncWithRequestBuilder(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, supportTicketPriorityDtoCollectionQueryParameters: SupportTicketPriorityDtoCollectionQueryParameters? = nil) -> RequestBuilder<SupportTicketPriorityDtoListEnvelope> {
        let localVariablePath = "/api/v2/SupportService/SupportTicketPriorities"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: supportTicketPriorityDtoCollectionQueryParameters)
     ...
     */
    @discardableResult
    open class func getSupportTicketPrioritiesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, supportTicketPriorityDtoCollectionQueryParameters: SupportTicketPriorityDtoCollectionQueryParameters? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Int32Envelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getSupportTicketPrioritiesCountAsyncWithRequestBuilder(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, supportTicketPriorityDtoCollectionQueryParameters: supportTicketPriorityDtoCollectionQueryParameters).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getSupportTicketPrioritiesCountAsyncWithRequestBuilder(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, supportTicketPriorityDtoCollectionQueryParameters: SupportTicketPriorityDtoCollectionQueryParameters? = nil) -> RequestBuilder<Int32Envelope> {
     ...
     */
    @discardableResult
    open class func patchSupportTicketPriorityAsync(tenantId: UUID, supportTicketPriorityId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmptyEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return patchSupportTicketPriorityAsyncWithRequestBuilder(tenantId: tenantId, supportTicketPriorityId: supportTicketPriorityId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Patch a support ticket priority
     - PATCH /api/v2/SupportService/SupportTicketPriorities/{supportTicketPriorityId}
     ...
     - returns: RequestBuilder<EmptyEnvelope> 
     */
    open class func patchSupportTicketPriorityAsyncWithRequestBuilder(tenantId: UUID, supportTicketPriorityId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil) -> RequestBuilder<EmptyEnvelope> {
        var localVariablePath = "/api/v2/SupportService/SupportTicketPriorities/{supportTicketPriorityId}"
        let supportTicketPriorityIdPreEscape = "\(APIHelper.mapValueToPathItem(supportTicketPriorityId))"
        let supportTicketPriorityIdPostEscape = supportTicketPriorityIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{supportTicketPriorityId}", with: supportTicketPriorityIdPostEscape, options: .literal, range: nil)
