//
// KnowledgeArticleCreateDto.swift
//
...
public struct KnowledgeArticleCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, title: String, slug: String? = nil, excerpt: String? = nil, description: String? = nil, content: String? = nil, highlightImage: String? = nil, seoTitle: String? = nil, seoKeyWords: String? = nil, metaDescription: String? = nil, published: Bool? = nil, enable: Bool? = nil) {
        self.id = id
