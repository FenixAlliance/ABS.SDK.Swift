//
// SupportTicketTypeCreateDto.swift
//
...
public struct SupportTicketTypeCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, title: String? = nil, description: String? = nil, businessID: String? = nil) {
        self.id = id
