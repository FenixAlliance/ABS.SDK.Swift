//
// InquiryRequestDtoListEnvelope.swift
//
...
public struct InquiryRequestDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [InquiryRequestDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [InquiryRequestDto]? = nil) {
