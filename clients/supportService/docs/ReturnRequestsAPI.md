...
```swift
    open class func getReturnRequestsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, returnRequestDtoCollectionQueryParameters: ReturnRequestDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ReturnRequestDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let returnRequestDtoCollectionQueryParameters = ReturnRequestDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ReturnRequestDtoCollectionQueryParameters |  (optional)

// Retrieve return requests
ReturnRequestsAPI.getReturnRequestsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, returnRequestDtoCollectionQueryParameters: returnRequestDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getReturnRequestsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, returnRequestDtoCollectionQueryParameters: ReturnRequestDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get return requests count
ReturnRequestsAPI.getReturnRequestsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, returnRequestDtoCollectionQueryParameters: returnRequestDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchReturnRequestAsync(tenantId: UUID, returnRequestId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a return request
ReturnRequestsAPI.patchReturnRequestAsync(tenantId: tenantId, returnRequestId: returnRequestId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
