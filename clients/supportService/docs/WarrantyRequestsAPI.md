...
```swift
    open class func getWarrantyRequestsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, warrantyRequestDtoCollectionQueryParameters: WarrantyRequestDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: WarrantyRequestDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let warrantyRequestDtoCollectionQueryParameters = WarrantyRequestDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // WarrantyRequestDtoCollectionQueryParameters |  (optional)

// Retrieve warranty requests
WarrantyRequestsAPI.getWarrantyRequestsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, warrantyRequestDtoCollectionQueryParameters: warrantyRequestDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getWarrantyRequestsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, warrantyRequestDtoCollectionQueryParameters: WarrantyRequestDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get warranty requests count
WarrantyRequestsAPI.getWarrantyRequestsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, warrantyRequestDtoCollectionQueryParameters: warrantyRequestDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchWarrantyRequestAsync(tenantId: UUID, warrantyRequestId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a warranty request
WarrantyRequestsAPI.patchWarrantyRequestAsync(tenantId: tenantId, warrantyRequestId: warrantyRequestId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
