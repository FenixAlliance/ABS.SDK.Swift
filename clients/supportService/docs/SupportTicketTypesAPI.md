...
```swift
    open class func getSupportTicketTypesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, supportTicketTypeDtoCollectionQueryParameters: SupportTicketTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: SupportTicketTypeDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let supportTicketTypeDtoCollectionQueryParameters = SupportTicketTypeDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // SupportTicketTypeDtoCollectionQueryParameters |  (optional)

// Retrieve a list of support ticket types
SupportTicketTypesAPI.getSupportTicketTypesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, supportTicketTypeDtoCollectionQueryParameters: supportTicketTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getSupportTicketTypesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, supportTicketTypeDtoCollectionQueryParameters: SupportTicketTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get the count of support ticket types
SupportTicketTypesAPI.getSupportTicketTypesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, supportTicketTypeDtoCollectionQueryParameters: supportTicketTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchSupportTicketTypeAsync(tenantId: UUID, supportTicketTypeId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a support ticket type
SupportTicketTypesAPI.patchSupportTicketTypeAsync(tenantId: tenantId, supportTicketTypeId: supportTicketTypeId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
