...
public struct LicenseCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, title: String, description: String? = nil, code: String? = nil, licenseTypeId: String? = nil) {
        self.id = id
