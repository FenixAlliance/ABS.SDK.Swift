//
// LicenseAttributeCreateDto.swift
//
...
public struct LicenseAttributeCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, code: String? = nil, name: String, description: String? = nil, licenseTypeId: String? = nil) {
        self.id = id
