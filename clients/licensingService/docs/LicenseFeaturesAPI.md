...
```swift
    open class func getLicenseFeaturesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, licenseFeatureDtoCollectionQueryParameters: LicenseFeatureDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: LicenseFeatureDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let licenseFeatureDtoCollectionQueryParameters = LicenseFeatureDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // LicenseFeatureDtoCollectionQueryParameters |  (optional)

// Get all license features
LicenseFeaturesAPI.getLicenseFeaturesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, licenseFeatureDtoCollectionQueryParameters: licenseFeatureDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getLicenseFeaturesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, licenseFeatureDtoCollectionQueryParameters: LicenseFeatureDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get license features count
LicenseFeaturesAPI.getLicenseFeaturesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, licenseFeatureDtoCollectionQueryParameters: licenseFeatureDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchLicenseFeatureAsync(tenantId: UUID, id: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a license feature
LicenseFeaturesAPI.patchLicenseFeatureAsync(tenantId: tenantId, id: id, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
