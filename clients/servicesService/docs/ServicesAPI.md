...
# **getServicesAsync**
```swift
    open class func getServicesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, serviceDtoCollectionQueryParameters: ServiceDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ServiceDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let serviceDtoCollectionQueryParameters = ServiceDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ServiceDtoCollectionQueryParameters |  (optional)

// Get all services
ServicesAPI.getServicesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, serviceDtoCollectionQueryParameters: serviceDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getServicesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, serviceDtoCollectionQueryParameters: ServiceDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get services count
ServicesAPI.getServicesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, serviceDtoCollectionQueryParameters: serviceDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchServiceAsync**
```swift
    open class func patchServiceAsync(tenantId: UUID, serviceId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: Envelope?, _ error: Error?) -> Void)
```
...
// Patch a service
ServicesAPI.patchServiceAsync(tenantId: tenantId, serviceId: serviceId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
