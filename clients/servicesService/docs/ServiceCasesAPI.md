...
```swift
    open class func getServiceCasesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, serviceCaseDtoCollectionQueryParameters: ServiceCaseDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ServiceCaseDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let serviceCaseDtoCollectionQueryParameters = ServiceCaseDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ServiceCaseDtoCollectionQueryParameters |  (optional)

// Get all service cases
ServiceCasesAPI.getServiceCasesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, serviceCaseDtoCollectionQueryParameters: serviceCaseDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getServiceCasesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, serviceCaseDtoCollectionQueryParameters: ServiceCaseDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get service cases count
ServiceCasesAPI.getServiceCasesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, serviceCaseDtoCollectionQueryParameters: serviceCaseDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchServiceCaseAsync(tenantId: UUID, serviceCaseId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: Envelope?, _ error: Error?) -> Void)
```
...
// Patch a service case
ServiceCasesAPI.patchServiceCaseAsync(tenantId: tenantId, serviceCaseId: serviceCaseId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
