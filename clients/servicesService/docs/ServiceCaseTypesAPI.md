...
```swift
    open class func getServiceCaseTypesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, serviceCaseTypeDtoCollectionQueryParameters: ServiceCaseTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ServiceCaseTypeDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let serviceCaseTypeDtoCollectionQueryParameters = ServiceCaseTypeDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ServiceCaseTypeDtoCollectionQueryParameters |  (optional)

// Get all service case types
ServiceCaseTypesAPI.getServiceCaseTypesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, serviceCaseTypeDtoCollectionQueryParameters: serviceCaseTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getServiceCaseTypesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, serviceCaseTypeDtoCollectionQueryParameters: ServiceCaseTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get service case types count
ServiceCaseTypesAPI.getServiceCaseTypesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, serviceCaseTypeDtoCollectionQueryParameters: serviceCaseTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchServiceCaseTypeAsync(tenantId: UUID, serviceCaseTypeId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: Envelope?, _ error: Error?) -> Void)
```
...
// Patch a service case type
ServiceCaseTypesAPI.patchServiceCaseTypeAsync(tenantId: tenantId, serviceCaseTypeId: serviceCaseTypeId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
