...
// Sum tenant accounting-entry credits
AccountingEntriesAPI.getCreditsSumAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion) { (response, error) in
...
// Sum tenant accounting-entry debits
AccountingEntriesAPI.getDebitsSumAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
