...
# **getGrantsAsync**
```swift
    open class func getGrantsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, grantDtoCollectionQueryParameters: GrantDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: GrantDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let grantDtoCollectionQueryParameters = GrantDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // GrantDtoCollectionQueryParameters |  (optional)

// Get all grants
GrantsAPI.getGrantsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, grantDtoCollectionQueryParameters: grantDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getGrantsCountAsync**
```swift
    open class func getGrantsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, grantDtoCollectionQueryParameters: GrantDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Count grants
GrantsAPI.getGrantsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, grantDtoCollectionQueryParameters: grantDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchGrantAsync**
```swift
    open class func patchGrantAsync(tenantId: UUID, grantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a grant
GrantsAPI.patchGrantAsync(tenantId: tenantId, grantId: grantId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
