...
```swift
    open class func getJournalTypesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, journalTypeDtoCollectionQueryParameters: JournalTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: JournalTypeDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let journalTypeDtoCollectionQueryParameters = JournalTypeDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // JournalTypeDtoCollectionQueryParameters |  (optional)

// Retrieves all journal types
JournalTypesAPI.getJournalTypesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, journalTypeDtoCollectionQueryParameters: journalTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getJournalTypesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, journalTypeDtoCollectionQueryParameters: JournalTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Counts journal types
JournalTypesAPI.getJournalTypesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, journalTypeDtoCollectionQueryParameters: journalTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchJournalTypeAsync(tenantId: UUID, journalTypeId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a journal type
JournalTypesAPI.patchJournalTypeAsync(tenantId: tenantId, journalTypeId: journalTypeId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
