...
# **getExpenseTypes**
```swift
    open class func getExpenseTypes(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, expenseTypeDtoCollectionQueryParameters: ExpenseTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ExpenseTypeDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let expenseTypeDtoCollectionQueryParameters = ExpenseTypeDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ExpenseTypeDtoCollectionQueryParameters |  (optional)

// Get all expense types for a tenant
ExpenseTypesAPI.getExpenseTypes(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, expenseTypeDtoCollectionQueryParameters: expenseTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getExpenseTypesCount(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, expenseTypeDtoCollectionQueryParameters: ExpenseTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get the count of expense types for a tenant
ExpenseTypesAPI.getExpenseTypesCount(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, expenseTypeDtoCollectionQueryParameters: expenseTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchExpenseType**
```swift
    open class func patchExpenseType(tenantId: UUID, expenseTypeId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch an expense type
ExpenseTypesAPI.patchExpenseType(tenantId: tenantId, expenseTypeId: expenseTypeId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
