...
public struct AccountTypeCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, name: String? = nil, description: String? = nil, tenantId: String? = nil, enrollmentId: String? = nil) {
        self.id = id
