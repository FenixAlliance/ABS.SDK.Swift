...
public struct CostCentreUpdateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, disabled: Bool? = nil, description: String? = nil, costCentreType: CostCentreType? = nil, costCentresGroupId: String? = nil, parentCostCentreId: String? = nil) {
        self.name = name
