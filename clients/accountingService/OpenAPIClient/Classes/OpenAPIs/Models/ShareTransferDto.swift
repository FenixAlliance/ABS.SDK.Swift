...
public struct ShareTransferDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, timestamp: Date? = nil, description: String? = nil, value: Double? = nil, newShareHolderId: String? = nil, formerShareHolderId: String? = nil, shareTransferReasonId: String? = nil, enrollmentId: String? = nil, tenantId: String? = nil) {
        self.id = id
