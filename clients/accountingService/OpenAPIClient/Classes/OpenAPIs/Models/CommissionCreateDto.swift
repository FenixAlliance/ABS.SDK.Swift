...
public struct CommissionCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, title: String? = nil, description: String? = nil, baseAmount: Double? = nil, addedPercent: Double? = nil, addedAmount: Double? = nil, taxComission: Double? = nil, salaryId: String? = nil, emisorWalletAccountId: String? = nil, receiverWalletAccountId: String? = nil, emisorContactId: String? = nil, receiverContactId: String? = nil) {
        self.id = id
