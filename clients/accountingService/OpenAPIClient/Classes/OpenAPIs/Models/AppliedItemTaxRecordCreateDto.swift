//
// AppliedItemTaxRecordCreateDto.swift
//
...
public struct AppliedItemTaxRecordCreateDto: Codable, JSONEncodable, Hashable {
    ...
    static let billingItemRecordIdRule = StringRule(minLength: 0, maxLength: 36, pattern: nil)
    public var id: UUID?
    ...
    public var billingItemRecordId: String?

    public init(id: UUID? = nil, timestamp: Date? = nil, taxPolicyId: String? = nil, invoiceId: String? = nil, itemId: String? = nil, taxAmountInUSD: Double? = nil, taxBaseAmountInUSD: Double? = nil, billingItemRecordId: String? = nil) {
        self.id = id
        ...
        self.billingItemRecordId = billingItemRecordId
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(billingItemRecordId, forKey: .billingItemRecordId)
    }
}
