//
// FiscalAuthorityDtoListEnvelope.swift
//
...
public struct FiscalAuthorityDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [FiscalAuthorityDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [FiscalAuthorityDto]? = nil) {
