//
// BankProfileDtoListEnvelope.swift
//
...
public struct BankProfileDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [BankProfileDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [BankProfileDto]? = nil) {
