...
# **getItemBrandsAsync**
```swift
    open class func getItemBrandsAsync(tenantId: UUID? = nil, apiVersion: String? = nil, xApiVersion: String? = nil, itemBrandDtoCollectionQueryParameters: ItemBrandDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ItemBrandDtoListEnvelope?, _ error: Error?) -> Void)
```
...
// Get all item brands
ItemBrandsAPI.getItemBrandsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, itemBrandDtoCollectionQueryParameters: itemBrandDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchItemBrandAsync**
```swift
    open class func patchItemBrandAsync(tenantId: UUID, itemBrandId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Patch an item brand
ItemBrandsAPI.patchItemBrandAsync(tenantId: tenantId, itemBrandId: itemBrandId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
