...
# **getItemBundlesAsync**
```swift
    open class func getItemBundlesAsync(tenantId: UUID? = nil, apiVersion: String? = nil, xApiVersion: String? = nil, itemBundleDtoCollectionQueryParameters: ItemBundleDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ItemBundleDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let itemBundleDtoCollectionQueryParameters = ItemBundleDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ItemBundleDtoCollectionQueryParameters |  (optional)

// Get all item bundles
ItemBundlesAPI.getItemBundlesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, itemBundleDtoCollectionQueryParameters: itemBundleDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getItemBundlesCountAsync(tenantId: UUID? = nil, apiVersion: String? = nil, xApiVersion: String? = nil, itemBundleDtoCollectionQueryParameters: ItemBundleDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get item bundles count
ItemBundlesAPI.getItemBundlesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, itemBundleDtoCollectionQueryParameters: itemBundleDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchItemBundleAsync(tenantId: UUID, itemBundleId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch an item bundle
ItemBundlesAPI.patchItemBundleAsync(tenantId: tenantId, itemBundleId: itemBundleId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
