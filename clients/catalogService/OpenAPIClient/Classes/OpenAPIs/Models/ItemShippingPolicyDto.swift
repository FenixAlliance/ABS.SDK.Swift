...
public struct ItemShippingPolicyDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, timestamp: Date? = nil, isExpressShipmentPolicy: Bool? = nil, shippingCourierID: String, type: String, code: String, title: String, description: String? = nil, isFree: Bool? = nil, reduce: Bool? = nil, isEnabled: Bool? = nil, isDefault: Bool? = nil, allowInternational: Bool? = nil, hours: Int? = nil, days: Int? = nil, weeks: Int? = nil, months: Int? = nil, years: Int? = nil, value: Double? = nil, percentage: Double? = nil, currencyID: String, countryID: String? = nil, countryStateID: String? = nil, customState: String? = nil, customCity: String? = nil, cityID: String? = nil, businessID: String, businessProfileRecordID: String? = nil) {
        self.id = id
