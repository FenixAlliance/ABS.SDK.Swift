...
public struct ItemReviewDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, timestamp: Date? = nil, itemID: String? = nil, reviewScore: Double? = nil, reviewMessage: String? = nil, socialProfileID: String? = nil) {
        self.id = id
