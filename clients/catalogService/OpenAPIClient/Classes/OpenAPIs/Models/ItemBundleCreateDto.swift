...
public struct ItemBundleCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, name: String, code: String? = nil, description: String? = nil, disabled: Bool? = nil) {
        self.id = id
