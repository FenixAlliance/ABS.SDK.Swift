...
public struct ItemFamilyCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, name: String, code: String? = nil, description: String? = nil) {
        self.id = id
