...
public struct MerchantDto: Codable, JSONEncodable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(merchantRating, forKey: .merchantRating)
    }
}
