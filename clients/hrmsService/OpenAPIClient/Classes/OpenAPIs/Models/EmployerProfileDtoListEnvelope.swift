//
// EmployerProfileDtoListEnvelope.swift
//
...
public struct EmployerProfileDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [EmployerProfileDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [EmployerProfileDto]? = nil) {
