//
// JobApplicantProfileCreateDto.swift
//
...
public struct JobApplicantProfileCreateDto: Codable, JSONEncodable, Hashable {

    public enum CareerLevel: String, Codable, CaseIterable {
        case junior = "Junior"
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, type: String? = nil, contactId: String? = nil, contact: ContactCreateDto? = nil, about: String? = nil, avatarUrl: String? = nil, data: String? = nil, dataLabel: String? = nil, data1: String? = nil, data1Label: String? = nil, data2: String? = nil, data2Label: String? = nil, data3: String? = nil, data3Label: String? = nil, data4: String? = nil, data4Label: String? = nil, data5: String? = nil, data5Label: String? = nil, data6: String? = nil, data6Label: String? = nil, data7: String? = nil, data7Label: String? = nil, data8: String? = nil, data8Label: String? = nil, data9: String? = nil, data9Label: String? = nil, availableForHire: Bool? = nil, careerLevel: CareerLevel? = nil, experienceInYears: Int? = nil, currentSalary: Double? = nil, minSalaryExpectation: Double? = nil, maxSalaryExpectation: Double? = nil, currencyId: String? = nil) {
        ...
        self.minSalaryExpectation = minSalaryExpectation
        self.maxSalaryExpectation = maxSalaryExpectation
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case data9
        case data9Label
        case availableForHire
        case careerLevel
        case experienceInYears
        case currentSalary
        case minSalaryExpectation
        case maxSalaryExpectation
        case currencyId
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(availableForHire, forKey: .availableForHire)
        try container.encodeIfPresent(careerLevel, forKey: .careerLevel)
        try container.encodeIfPresent(experienceInYears, forKey: .experienceInYears)
        try container.encodeIfPresent(currentSalary, forKey: .currentSalary)
        try container.encodeIfPresent(minSalaryExpectation, forKey: .minSalaryExpectation)
        try container.encodeIfPresent(maxSalaryExpectation, forKey: .maxSalaryExpectation)
