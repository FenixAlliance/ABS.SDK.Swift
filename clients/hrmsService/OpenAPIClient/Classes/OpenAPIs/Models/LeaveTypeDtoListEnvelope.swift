//
// LeaveTypeDtoListEnvelope.swift
//
...
public struct LeaveTypeDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [LeaveTypeDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [LeaveTypeDto]? = nil) {
