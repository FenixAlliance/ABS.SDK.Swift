//
// GigApplicationDtoListEnvelope.swift
//
...
public struct GigApplicationDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [GigApplicationDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [GigApplicationDto]? = nil) {
