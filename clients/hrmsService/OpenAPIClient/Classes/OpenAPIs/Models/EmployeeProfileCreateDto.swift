//
// EmployeeProfileCreateDto.swift
//
...
public struct EmployeeProfileCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, type: String? = nil, contactId: String? = nil, contact: ContactCreateDto? = nil, about: String? = nil, avatarUrl: String? = nil, data: String? = nil, dataLabel: String? = nil, data1: String? = nil, data1Label: String? = nil, data2: String? = nil, data2Label: String? = nil, data3: String? = nil, data3Label: String? = nil, data4: String? = nil, data4Label: String? = nil, data5: String? = nil, data5Label: String? = nil, data6: String? = nil, data6Label: String? = nil, data7: String? = nil, data7Label: String? = nil, data8: String? = nil, data8Label: String? = nil, data9: String? = nil, data9Label: String? = nil, grossPay: Double? = nil, netSalary: Double? = nil, payrollCurrency: String? = nil, maxWorkHoursPerDay: Int? = nil, jobTitleId: String? = nil, employeeTypeId: String? = nil) {
        ...
        self.payrollCurrency = payrollCurrency
        self.maxWorkHoursPerDay = maxWorkHoursPerDay
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(payrollCurrency, forKey: .payrollCurrency)
        try container.encodeIfPresent(maxWorkHoursPerDay, forKey: .maxWorkHoursPerDay)
        try container.encodeIfPresent(jobTitleId, forKey: .jobTitleId)
        try container.encodeIfPresent(employeeTypeId, forKey: .employeeTypeId)
    }
}
