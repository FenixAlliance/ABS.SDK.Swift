...
open class EmployeesAPI {
    ...
    /**
     ...
     - parameter apiVersion: (query)  (optional)
     - parameter xApiVersion: (header)  (optional)
     - parameter employeeProfileDtoCollectionQueryParameters: (body)  (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func getEmployeesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, employeeProfileDtoCollectionQueryParameters: EmployeeProfileDtoCollectionQueryParameters? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmployeeProfileDtoListEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getEmployeesAsyncWithRequestBuilder(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, employeeProfileDtoCollectionQueryParameters: employeeProfileDtoCollectionQueryParameters).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getEmployeesAsyncWithRequestBuilder(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, employeeProfileDtoCollectionQueryParameters: EmployeeProfileDtoCollectionQueryParameters? = nil) -> RequestBuilder<EmployeeProfileDtoListEnvelope> {
        let localVariablePath = "/api/v2/HrmsService/Employees"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: employeeProfileDtoCollectionQueryParameters)
     ...
     */
    @discardableResult
    open class func getEmployeesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, employeeProfileDtoCollectionQueryParameters: EmployeeProfileDtoCollectionQueryParameters? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Int32Envelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getEmployeesCountAsyncWithRequestBuilder(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, employeeProfileDtoCollectionQueryParameters: employeeProfileDtoCollectionQueryParameters).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getEmployeesCountAsyncWithRequestBuilder(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, employeeProfileDtoCollectionQueryParameters: EmployeeProfileDtoCollectionQueryParameters? = nil) -> RequestBuilder<Int32Envelope> {
     ...
     */
    @discardableResult
    open class func patchEmployeeAsync(tenantId: UUID, employeeId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmptyEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return patchEmployeeAsyncWithRequestBuilder(tenantId: tenantId, employeeId: employeeId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Patch an employee
     - PATCH /api/v2/HrmsService/Employees/{employeeId}
     ...
     - returns: RequestBuilder<EmptyEnvelope> 
     */
    open class func patchEmployeeAsyncWithRequestBuilder(tenantId: UUID, employeeId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil) -> RequestBuilder<EmptyEnvelope> {
        var localVariablePath = "/api/v2/HrmsService/Employees/{employeeId}"
        let employeeIdPreEscape = "\(APIHelper.mapValueToPathItem(employeeId))"
        let employeeIdPostEscape = employeeIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{employeeId}", with: employeeIdPostEscape, options: .literal, range: nil)
