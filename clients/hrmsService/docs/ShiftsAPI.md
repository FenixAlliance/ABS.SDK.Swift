...
# **getShiftsAsync**
```swift
    open class func getShiftsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, shiftDtoCollectionQueryParameters: ShiftDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ShiftDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let shiftDtoCollectionQueryParameters = ShiftDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ShiftDtoCollectionQueryParameters |  (optional)

// Get shifts
ShiftsAPI.getShiftsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, shiftDtoCollectionQueryParameters: shiftDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getShiftsCountAsync**
```swift
    open class func getShiftsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, shiftDtoCollectionQueryParameters: ShiftDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Count shifts
ShiftsAPI.getShiftsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, shiftDtoCollectionQueryParameters: shiftDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchShiftAsync**
```swift
    open class func patchShiftAsync(tenantId: UUID, shiftId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a shift
ShiftsAPI.patchShiftAsync(tenantId: tenantId, shiftId: shiftId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
