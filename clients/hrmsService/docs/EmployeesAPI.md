...
# **getEmployeesAsync**
```swift
    open class func getEmployeesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, employeeProfileDtoCollectionQueryParameters: EmployeeProfileDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: EmployeeProfileDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let employeeProfileDtoCollectionQueryParameters = EmployeeProfileDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // EmployeeProfileDtoCollectionQueryParameters |  (optional)

// Get employees
EmployeesAPI.getEmployeesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, employeeProfileDtoCollectionQueryParameters: employeeProfileDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getEmployeesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, employeeProfileDtoCollectionQueryParameters: EmployeeProfileDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Count employees
EmployeesAPI.getEmployeesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, employeeProfileDtoCollectionQueryParameters: employeeProfileDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchEmployeeAsync**
```swift
    open class func patchEmployeeAsync(tenantId: UUID, employeeId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch an employee
EmployeesAPI.patchEmployeeAsync(tenantId: tenantId, employeeId: employeeId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
