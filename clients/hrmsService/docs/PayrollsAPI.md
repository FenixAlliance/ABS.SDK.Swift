...
# **getPayrollsAsync**
```swift
    open class func getPayrollsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, payrollDtoCollectionQueryParameters: PayrollDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: PayrollDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let payrollDtoCollectionQueryParameters = PayrollDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // PayrollDtoCollectionQueryParameters |  (optional)

// Get payrolls
PayrollsAPI.getPayrollsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, payrollDtoCollectionQueryParameters: payrollDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getPayrollsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, payrollDtoCollectionQueryParameters: PayrollDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Count payrolls
PayrollsAPI.getPayrollsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, payrollDtoCollectionQueryParameters: payrollDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchPayrollAsync**
```swift
    open class func patchPayrollAsync(tenantId: UUID, payrollId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a payroll
PayrollsAPI.patchPayrollAsync(tenantId: tenantId, payrollId: payrollId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
