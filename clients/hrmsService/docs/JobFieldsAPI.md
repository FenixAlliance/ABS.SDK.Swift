...
# **getJobFieldsAsync**
```swift
    open class func getJobFieldsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, jobFieldDtoCollectionQueryParameters: JobFieldDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: JobFieldDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let jobFieldDtoCollectionQueryParameters = JobFieldDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // JobFieldDtoCollectionQueryParameters |  (optional)

// Get job fields
JobFieldsAPI.getJobFieldsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, jobFieldDtoCollectionQueryParameters: jobFieldDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getJobFieldsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, jobFieldDtoCollectionQueryParameters: JobFieldDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Count job fields
JobFieldsAPI.getJobFieldsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, jobFieldDtoCollectionQueryParameters: jobFieldDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchJobFieldAsync**
```swift
    open class func patchJobFieldAsync(tenantId: UUID, jobFieldId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a job field
JobFieldsAPI.patchJobFieldAsync(tenantId: tenantId, jobFieldId: jobFieldId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
