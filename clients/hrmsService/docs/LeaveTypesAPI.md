...
# **getLeaveTypesAsync**
```swift
    open class func getLeaveTypesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, leaveTypeDtoCollectionQueryParameters: LeaveTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: LeaveTypeDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let leaveTypeDtoCollectionQueryParameters = LeaveTypeDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // LeaveTypeDtoCollectionQueryParameters |  (optional)

// Get leave types
LeaveTypesAPI.getLeaveTypesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, leaveTypeDtoCollectionQueryParameters: leaveTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getLeaveTypesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, leaveTypeDtoCollectionQueryParameters: LeaveTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Count leave types
LeaveTypesAPI.getLeaveTypesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, leaveTypeDtoCollectionQueryParameters: leaveTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
