...
```swift
    open class func getPaymentMethodsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, paymentMethodDtoCollectionQueryParameters: PaymentMethodDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: PaymentMethodDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let paymentMethodDtoCollectionQueryParameters = PaymentMethodDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // PaymentMethodDtoCollectionQueryParameters |  (optional)

// Retrieves all payment methods
PaymentMethodsAPI.getPaymentMethodsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, paymentMethodDtoCollectionQueryParameters: paymentMethodDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getPaymentMethodsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, paymentMethodDtoCollectionQueryParameters: PaymentMethodDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Counts payment methods
PaymentMethodsAPI.getPaymentMethodsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, paymentMethodDtoCollectionQueryParameters: paymentMethodDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchPaymentMethodAsync(tenantId: UUID, paymentMethodId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a payment method
PaymentMethodsAPI.patchPaymentMethodAsync(tenantId: tenantId, paymentMethodId: paymentMethodId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
