...
```swift
    open class func getPaymentTermsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, paymentTermDtoCollectionQueryParameters: PaymentTermDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: PaymentTermDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let paymentTermDtoCollectionQueryParameters = PaymentTermDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // PaymentTermDtoCollectionQueryParameters |  (optional)

// Retrieves all payment terms
PaymentTermsAPI.getPaymentTermsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, paymentTermDtoCollectionQueryParameters: paymentTermDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getPaymentTermsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, paymentTermDtoCollectionQueryParameters: PaymentTermDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Counts payment terms
PaymentTermsAPI.getPaymentTermsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, paymentTermDtoCollectionQueryParameters: paymentTermDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchPaymentTermAsync(tenantId: UUID, paymentTermId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a payment term
PaymentTermsAPI.patchPaymentTermAsync(tenantId: tenantId, paymentTermId: paymentTermId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
