...
open class MarketingListsAPI {
    ...
    /**
     ...
     - parameter apiVersion: (query)  (optional)
     - parameter xApiVersion: (header)  (optional)
     - parameter marketingListDtoCollectionQueryParameters: (body)  (optional)
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func getMarketingListODataAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, marketingListDtoCollectionQueryParameters: MarketingListDtoCollectionQueryParameters? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: MarketingListDtoListEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getMarketingListODataAsyncWithRequestBuilder(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, marketingListDtoCollectionQueryParameters: marketingListDtoCollectionQueryParameters).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getMarketingListODataAsyncWithRequestBuilder(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, marketingListDtoCollectionQueryParameters: MarketingListDtoCollectionQueryParameters? = nil) -> RequestBuilder<MarketingListDtoListEnvelope> {
        let localVariablePath = "/api/v2/MarketingService/MarketingLists"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: marketingListDtoCollectionQueryParameters)
     ...
     */
    @discardableResult
    open class func getMarketingListsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, marketingListDtoCollectionQueryParameters: MarketingListDtoCollectionQueryParameters? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Int32Envelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getMarketingListsCountAsyncWithRequestBuilder(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, marketingListDtoCollectionQueryParameters: marketingListDtoCollectionQueryParameters).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getMarketingListsCountAsyncWithRequestBuilder(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, marketingListDtoCollectionQueryParameters: MarketingListDtoCollectionQueryParameters? = nil) -> RequestBuilder<Int32Envelope> {
     ...
     */
    @discardableResult
    open class func patchMarketingListAsync(tenantId: UUID, marketinglistId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmptyEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return patchMarketingListAsyncWithRequestBuilder(tenantId: tenantId, marketinglistId: marketinglistId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - returns: RequestBuilder<EmptyEnvelope> 
     */
    open class func patchMarketingListAsyncWithRequestBuilder(tenantId: UUID, marketinglistId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil) -> RequestBuilder<EmptyEnvelope> {
        var localVariablePath = "/api/v2/MarketingService/MarketingLists/{marketinglistId}"
        let marketinglistIdPreEscape = "\(APIHelper.mapValueToPathItem(marketinglistId))"
        let marketinglistIdPostEscape = marketinglistIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{marketinglistId}", with: marketinglistIdPostEscape, options: .literal, range: nil)
