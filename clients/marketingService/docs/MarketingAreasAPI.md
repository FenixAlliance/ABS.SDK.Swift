...
```swift
    open class func getMarketingAreasAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, marketingAreaDtoCollectionQueryParameters: MarketingAreaDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: MarketingAreaDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let marketingAreaDtoCollectionQueryParameters = MarketingAreaDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // MarketingAreaDtoCollectionQueryParameters |  (optional)

// Get marketing areas
MarketingAreasAPI.getMarketingAreasAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, marketingAreaDtoCollectionQueryParameters: marketingAreaDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getMarketingAreasCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, marketingAreaDtoCollectionQueryParameters: MarketingAreaDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Count marketing areas
MarketingAreasAPI.getMarketingAreasCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, marketingAreaDtoCollectionQueryParameters: marketingAreaDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchMarketingAreaAsync(tenantId: UUID, marketingAreaId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a marketing area
MarketingAreasAPI.patchMarketingAreaAsync(tenantId: tenantId, marketingAreaId: marketingAreaId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
