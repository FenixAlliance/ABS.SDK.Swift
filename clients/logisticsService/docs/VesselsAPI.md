...
# **getVesselsAsync**
```swift
    open class func getVesselsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, vesselDtoCollectionQueryParameters: VesselDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: VesselDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let vesselDtoCollectionQueryParameters = VesselDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // VesselDtoCollectionQueryParameters |  (optional)

// Get all vessels
VesselsAPI.getVesselsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, vesselDtoCollectionQueryParameters: vesselDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getVesselsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, vesselDtoCollectionQueryParameters: VesselDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get vessels count
VesselsAPI.getVesselsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, vesselDtoCollectionQueryParameters: vesselDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchVesselAsync**
```swift
    open class func patchVesselAsync(tenantId: UUID, vesselId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a vessel
VesselsAPI.patchVesselAsync(tenantId: tenantId, vesselId: vesselId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
