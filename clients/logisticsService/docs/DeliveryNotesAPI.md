...
```swift
    open class func getDeliveryNotesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, deliveryNoteDtoCollectionQueryParameters: DeliveryNoteDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: DeliveryNoteDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let deliveryNoteDtoCollectionQueryParameters = DeliveryNoteDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // DeliveryNoteDtoCollectionQueryParameters |  (optional)

// Get all delivery notes
DeliveryNotesAPI.getDeliveryNotesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, deliveryNoteDtoCollectionQueryParameters: deliveryNoteDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getDeliveryNotesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, deliveryNoteDtoCollectionQueryParameters: DeliveryNoteDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get delivery notes count
DeliveryNotesAPI.getDeliveryNotesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, deliveryNoteDtoCollectionQueryParameters: deliveryNoteDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
