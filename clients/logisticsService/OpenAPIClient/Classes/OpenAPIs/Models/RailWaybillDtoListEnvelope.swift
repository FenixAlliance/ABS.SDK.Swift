//
// RailWaybillDtoListEnvelope.swift
//
...
public struct RailWaybillDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [RailWaybillDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [RailWaybillDto]? = nil) {
