...
```swift
    open class func countWebContentsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, webContentDtoCollectionQueryParameters: WebContentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
let webContentDtoCollectionQueryParameters = WebContentDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // WebContentDtoCollectionQueryParameters |  (optional)

// Count web contents
WebContentsAPI.countWebContentsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, webContentDtoCollectionQueryParameters: webContentDtoCollectionQueryParameters) { (response, error) in
...
# **getWebContentsAsync**
```swift
    open class func getWebContentsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, webContentDtoCollectionQueryParameters: WebContentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: WebContentDtoListEnvelope?, _ error: Error?) -> Void)
```
...
// Get web contents
WebContentsAPI.getWebContentsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, webContentDtoCollectionQueryParameters: webContentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchWebContentAsync(tenantId: UUID, webContentId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a web content
WebContentsAPI.patchWebContentAsync(tenantId: tenantId, webContentId: webContentId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
