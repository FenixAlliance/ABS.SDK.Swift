...
public struct WebPageCreateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID? = nil, timestamp: Date? = nil, tenantId: String? = nil, enrollmentId: String? = nil, title: String? = nil, code: String? = nil, published: Bool? = nil, description: String? = nil, htmlContent: String? = nil, featuredImageUrl: String? = nil, codeType: CodeType? = nil, webTemplateID: String? = nil) {
        self.id = id
