...
open class BusinessDomainsAPI {
     ...
     */
    @discardableResult
    open class func getBusinessDomainsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, businessDomainDtoCollectionQueryParameters: BusinessDomainDtoCollectionQueryParameters? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: BusinessDomainDtoListEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getBusinessDomainsAsyncWithRequestBuilder(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, businessDomainDtoCollectionQueryParameters: businessDomainDtoCollectionQueryParameters).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getBusinessDomainsAsyncWithRequestBuilder(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, businessDomainDtoCollectionQueryParameters: BusinessDomainDtoCollectionQueryParameters? = nil) -> RequestBuilder<BusinessDomainDtoListEnvelope> {
        let localVariablePath = "/api/v2/ContentService/BusinessDomains"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
     ...
     */
    @discardableResult
    open class func getBusinessDomainsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, businessDomainDtoCollectionQueryParameters: BusinessDomainDtoCollectionQueryParameters? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Int32Envelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getBusinessDomainsCountAsyncWithRequestBuilder(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, businessDomainDtoCollectionQueryParameters: businessDomainDtoCollectionQueryParameters).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func getBusinessDomainsCountAsyncWithRequestBuilder(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, businessDomainDtoCollectionQueryParameters: BusinessDomainDtoCollectionQueryParameters? = nil) -> RequestBuilder<Int32Envelope> {
