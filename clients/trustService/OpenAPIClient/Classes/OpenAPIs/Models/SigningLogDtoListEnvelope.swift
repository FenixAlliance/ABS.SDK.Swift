//
// SigningLogDtoListEnvelope.swift
//
...
public struct SigningLogDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [SigningLogDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [SigningLogDto]? = nil) {
