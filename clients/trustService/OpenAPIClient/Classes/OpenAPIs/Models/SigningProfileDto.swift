...
public struct SigningProfileDto: Codable, JSONEncodable, Hashable {
    ...
    public enum SignaturePurpose: String, Codable, CaseIterable {
        case unknown = "Unknown"
    ...
    public var signaturePurpose: SignaturePurpose?
    ...
    public init(id: String? = nil, timestamp: Date? = nil, contactId: String? = nil, tenantId: String? = nil, type: String? = nil, enrollmentId: String? = nil, about: String? = nil, verified: Bool? = nil, submitted: Bool? = nil, avatarUrl: String? = nil, contact: ContactDto? = nil, qualifiedName: String? = nil, verificationTimestamp: Date? = nil, data: String? = nil, dataLabel: String? = nil, data1: String? = nil, data1Label: String? = nil, data2: String? = nil, data2Label: String? = nil, data3: String? = nil, data3Label: String? = nil, data4: String? = nil, data4Label: String? = nil, data5: String? = nil, data5Label: String? = nil, data6: String? = nil, data6Label: String? = nil, data7: String? = nil, data7Label: String? = nil, data8: String? = nil, data8Label: String? = nil, data9: String? = nil, data9Label: String? = nil, contactName: String? = nil, signatureFormat: SignatureFormat? = nil, signaturePurpose: SignaturePurpose? = nil, digestAlgorithm: String? = nil, signatureAlgorithm: String? = nil, canonicalizationAlgorithm: String? = nil, policyIdentifier: String? = nil, policyUri: String? = nil, authorityProfile: String? = nil, isActive: Bool? = nil, defaultForDocumentType: String? = nil) {
        ...
        self.defaultForDocumentType = defaultForDocumentType
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(defaultForDocumentType, forKey: .defaultForDocumentType)
    }
}
