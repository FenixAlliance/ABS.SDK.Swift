...
```swift
    open class func getSubscriptionPlansAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, subscriptionDtoCollectionQueryParameters: SubscriptionDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: SubscriptionPlanDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let subscriptionDtoCollectionQueryParameters = SubscriptionDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // SubscriptionDtoCollectionQueryParameters |  (optional)

// Get all subscription plans
SubscriptionPlansAPI.getSubscriptionPlansAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, subscriptionDtoCollectionQueryParameters: subscriptionDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getSubscriptionPlansCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, subscriptionDtoCollectionQueryParameters: SubscriptionDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get subscription plans count
SubscriptionPlansAPI.getSubscriptionPlansCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, subscriptionDtoCollectionQueryParameters: subscriptionDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchSubscriptionPlanAsync(tenantId: UUID, planId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a subscription plan
SubscriptionPlansAPI.patchSubscriptionPlanAsync(tenantId: tenantId, planId: planId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
