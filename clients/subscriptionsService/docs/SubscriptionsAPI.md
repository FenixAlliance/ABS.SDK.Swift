...
```swift
    open class func getSubscriptionsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, subscriptionDtoCollectionQueryParameters: SubscriptionDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: SubscriptionDtoIReadOnlyListEnvelope?, _ error: Error?) -> Void)
```
...
// Get all subscriptions
SubscriptionsAPI.getSubscriptionsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, subscriptionDtoCollectionQueryParameters: subscriptionDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getSubscriptionsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, subscriptionDtoCollectionQueryParameters: SubscriptionDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get subscriptions count
SubscriptionsAPI.getSubscriptionsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, subscriptionDtoCollectionQueryParameters: subscriptionDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchSubscriptionAsync(tenantId: UUID, subscriptionId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a subscription
SubscriptionsAPI.patchSubscriptionAsync(tenantId: tenantId, subscriptionId: subscriptionId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
