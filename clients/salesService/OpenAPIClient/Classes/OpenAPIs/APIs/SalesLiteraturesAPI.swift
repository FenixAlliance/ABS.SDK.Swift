...
open class SalesLiteraturesAPI {
    ...
    /**
     Create a sales literature
     - POST /api/v2/SalesService/SalesLiteratures
    ...
    /**
     Delete a sales literature
     - DELETE /api/v2/SalesService/SalesLiteratures/{salesLiteratureId}
    ...
    /**
     Get sales literature by ID
     - GET /api/v2/SalesService/SalesLiteratures/{salesLiteratureId}
    ...
    /**
     Update a sales literature
     - PUT /api/v2/SalesService/SalesLiteratures/{salesLiteratureId}
