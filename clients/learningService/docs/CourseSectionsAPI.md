...
```swift
    open class func getCourseSectionsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, courseSectionDtoCollectionQueryParameters: CourseSectionDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: [CourseSectionDto]?, _ error: Error?) -> Void)
```
...
// Get all course sections
CourseSectionsAPI.getCourseSectionsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, courseSectionDtoCollectionQueryParameters: courseSectionDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getCourseSectionsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, courseSectionDtoCollectionQueryParameters: CourseSectionDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int?, _ error: Error?) -> Void)
```
...
// Get course sections count
CourseSectionsAPI.getCourseSectionsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, courseSectionDtoCollectionQueryParameters: courseSectionDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchCourseSectionAsync(tenantId: UUID, sectionId: String, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a course section
CourseSectionsAPI.patchCourseSectionAsync(tenantId: tenantId, sectionId: sectionId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
