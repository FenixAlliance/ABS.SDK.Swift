...
# **getEnrollmentsAsync**
```swift
    open class func getEnrollmentsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, courseEnrollmentDtoCollectionQueryParameters: CourseEnrollmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: [CourseEnrollmentDto]?, _ error: Error?) -> Void)
```
...
// Get all course enrollments
CourseEnrollmentsAPI.getEnrollmentsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, courseEnrollmentDtoCollectionQueryParameters: courseEnrollmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getEnrollmentsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, courseEnrollmentDtoCollectionQueryParameters: CourseEnrollmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int?, _ error: Error?) -> Void)
```
...
// Get course enrollments count
CourseEnrollmentsAPI.getEnrollmentsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, courseEnrollmentDtoCollectionQueryParameters: courseEnrollmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getStudentCourseEnrollmentsAsync(tenantId: UUID, studentProfileId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, courseEnrollmentDtoCollectionQueryParameters: CourseEnrollmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: [CourseEnrollmentDto]?, _ error: Error?) -> Void)
```
...
// Get enrollments by student
CourseEnrollmentsAPI.getStudentCourseEnrollmentsAsync(tenantId: tenantId, studentProfileId: studentProfileId, apiVersion: apiVersion, xApiVersion: xApiVersion, courseEnrollmentDtoCollectionQueryParameters: courseEnrollmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchCourseEnrollmentAsync(tenantId: UUID, courseEnrollmentId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Patch a course enrollment
CourseEnrollmentsAPI.patchCourseEnrollmentAsync(tenantId: tenantId, courseEnrollmentId: courseEnrollmentId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
