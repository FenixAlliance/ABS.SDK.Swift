//
// LocationDtoIReadOnlyListEnvelope.swift
//
...
public struct LocationDtoIReadOnlyListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [LocationDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [LocationDto]? = nil) {
