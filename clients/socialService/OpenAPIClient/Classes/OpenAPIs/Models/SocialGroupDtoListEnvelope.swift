//
// SocialGroupDtoListEnvelope.swift
//
...
public struct SocialGroupDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [SocialGroupDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [SocialGroupDto]? = nil) {
