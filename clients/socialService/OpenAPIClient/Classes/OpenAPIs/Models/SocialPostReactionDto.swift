...
public struct SocialPostReactionDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, timestamp: Date? = nil, reaction: Reaction? = nil, reactionValue: String? = nil, socialProfileId: String? = nil, socialProfileName: String? = nil, socialProfileAvatarUrl: String? = nil, socialProfileType: SocialProfileType? = nil, socialPostId: String? = nil) {
        self.id = id
