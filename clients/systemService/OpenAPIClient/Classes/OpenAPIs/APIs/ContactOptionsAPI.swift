...
open class ContactOptionsAPI {
     ...
     */
    @discardableResult
    open class func createSystemContactOption(contactId: UUID, key: String, portalId: UUID? = nil, apiVersion: String? = nil, xApiVersion: String? = nil, optionCreateDto: OptionCreateDto? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmptyEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return createSystemContactOptionWithRequestBuilder(contactId: contactId, key: key, portalId: portalId, apiVersion: apiVersion, xApiVersion: xApiVersion, optionCreateDto: optionCreateDto).execute(apiResponseQueue) { result in
            switch result {
    ...
    /**
     Create a new contact option (admin)
     - POST /api/v2/SystemService/Contacts/{contactId}/Options
     ...
     */
    open class func createSystemContactOptionWithRequestBuilder(contactId: UUID, key: String, portalId: UUID? = nil, apiVersion: String? = nil, xApiVersion: String? = nil, optionCreateDto: OptionCreateDto? = nil) -> RequestBuilder<EmptyEnvelope> {
     ...
     */
    @discardableResult
    open class func deleteSystemContactOption(contactId: UUID, optionId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmptyEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return deleteSystemContactOptionWithRequestBuilder(contactId: contactId, optionId: optionId, apiVersion: apiVersion, xApiVersion: xApiVersion).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Delete a contact option (admin)
     - DELETE /api/v2/SystemService/Contacts/{contactId}/Options/{optionId}
     ...
     - returns: RequestBuilder<EmptyEnvelope> 
     */
    open class func deleteSystemContactOptionWithRequestBuilder(contactId: UUID, optionId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<EmptyEnvelope> {
     ...
     */
    @discardableResult
    open class func getSystemContactOptionById(contactId: UUID, optionId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: OptionDtoEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getSystemContactOptionByIdWithRequestBuilder(contactId: contactId, optionId: optionId, apiVersion: apiVersion, xApiVersion: xApiVersion).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Retrieve a single contact option by its ID (admin)
     - GET /api/v2/SystemService/Contacts/{contactId}/Options/{optionId}
     ...
     */
    open class func getSystemContactOptionByIdWithRequestBuilder(contactId: UUID, optionId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<OptionDtoEnvelope> {
        var localVariablePath = "/api/v2/SystemService/Contacts/{contactId}/Options/{optionId}"
        let contactIdPreEscape = "\(APIHelper.mapValueToPathItem(contactId))"
        let contactIdPostEscape = contactIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{contactId}", with: contactIdPostEscape, options: .literal, range: nil)
    ...
    /**
     Retrieve a list of contact options (admin)
     - GET /api/v2/SystemService/Contacts/{contactId}/Options
    ...
    /**
     Get the count of contact options (admin)
     - GET /api/v2/SystemService/Contacts/{contactId}/Options/Count
    ...
    /**
     Partially update a contact option (admin)
     - PATCH /api/v2/SystemService/Contacts/{contactId}/Options/{optionId}
     ...
     */
    @discardableResult
    open class func updateSystemContactOption(contactId: UUID, optionId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, optionUpdateDto: OptionUpdateDto? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmptyEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return updateSystemContactOptionWithRequestBuilder(contactId: contactId, optionId: optionId, apiVersion: apiVersion, xApiVersion: xApiVersion, optionUpdateDto: optionUpdateDto).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Update a contact option (admin)
     - PUT /api/v2/SystemService/Contacts/{contactId}/Options/{optionId}
     ...
     - returns: RequestBuilder<EmptyEnvelope> 
     */
    open class func updateSystemContactOptionWithRequestBuilder(contactId: UUID, optionId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, optionUpdateDto: OptionUpdateDto? = nil) -> RequestBuilder<EmptyEnvelope> {
        var localVariablePath = "/api/v2/SystemService/Contacts/{contactId}/Options/{optionId}"
        let contactIdPreEscape = "\(APIHelper.mapValueToPathItem(contactId))"
        let contactIdPostEscape = contactIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{contactId}", with: contactIdPostEscape, options: .literal, range: nil)
