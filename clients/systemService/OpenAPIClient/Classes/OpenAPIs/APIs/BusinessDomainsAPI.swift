...
open class BusinessDomainsAPI {
     ...
     */
    @discardableResult
    open class func deleteSystemBusinessDomain(businessDomainId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmptyEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return deleteSystemBusinessDomainWithRequestBuilder(businessDomainId: businessDomainId, apiVersion: apiVersion, xApiVersion: xApiVersion).execute(apiResponseQueue) { result in
            switch result {
    ...
    /**
     Delete a business domain
     - DELETE /api/v2/SystemService/BusinessDomains/{businessDomainId}
     ...
     */
    open class func deleteSystemBusinessDomainWithRequestBuilder(businessDomainId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<EmptyEnvelope> {
        var localVariablePath = "/api/v2/SystemService/BusinessDomains/{businessDomainId}"
     ...
     */
    @discardableResult
    open class func getSystemBusinessDomainById(businessDomainId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: BusinessDomainDtoEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return getSystemBusinessDomainByIdWithRequestBuilder(businessDomainId: businessDomainId, apiVersion: apiVersion, xApiVersion: xApiVersion).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Retrieve a business domain by its ID
     - GET /api/v2/SystemService/BusinessDomains/{businessDomainId}
     ...
     */
    open class func getSystemBusinessDomainByIdWithRequestBuilder(businessDomainId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<BusinessDomainDtoEnvelope> {
        var localVariablePath = "/api/v2/SystemService/BusinessDomains/{businessDomainId}"
        let businessDomainIdPreEscape = "\(APIHelper.mapValueToPathItem(businessDomainId))"
        let businessDomainIdPostEscape = businessDomainIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{businessDomainId}", with: businessDomainIdPostEscape, options: .literal, range: nil)
    ...
    /**
     Retrieve all business domains in the system
     - GET /api/v2/SystemService/BusinessDomains
    ...
    /**
     Get the count of all business domains in the system
     - GET /api/v2/SystemService/BusinessDomains/Count
     ...
     */
    @discardableResult
    open class func verifySystemBusinessDomain(businessDomainId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EmptyEnvelope?, _ error: Error?) -> Void)) -> RequestTask {
        return verifySystemBusinessDomainWithRequestBuilder(businessDomainId: businessDomainId, apiVersion: apiVersion, xApiVersion: xApiVersion).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Verify a business domain
     - POST /api/v2/SystemService/BusinessDomains/{businessDomainId}/Verify
     ...
     - returns: RequestBuilder<EmptyEnvelope> 
     */
    open class func verifySystemBusinessDomainWithRequestBuilder(businessDomainId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil) -> RequestBuilder<EmptyEnvelope> {
        var localVariablePath = "/api/v2/SystemService/BusinessDomains/{businessDomainId}/Verify"
        let businessDomainIdPreEscape = "\(APIHelper.mapValueToPathItem(businessDomainId))"
        let businessDomainIdPostEscape = businessDomainIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{businessDomainId}", with: businessDomainIdPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
