...
public struct SecurityPermissionDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, timestamp: Date? = nil, name: String? = nil, tenantId: String? = nil, category: String? = nil, description: String? = nil, isSystemPermission: Bool? = nil) {
        self.id = id
