...
```swift
    open class func getProductionPlansAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, productionPlanDtoCollectionQueryParameters: ProductionPlanDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ProductionPlanDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let productionPlanDtoCollectionQueryParameters = ProductionPlanDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ProductionPlanDtoCollectionQueryParameters |  (optional)

// Get all production plans
ProductionPlansAPI.getProductionPlansAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, productionPlanDtoCollectionQueryParameters: productionPlanDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getProductionPlansCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, productionPlanDtoCollectionQueryParameters: ProductionPlanDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get production plans count
ProductionPlansAPI.getProductionPlansCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, productionPlanDtoCollectionQueryParameters: productionPlanDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchProductionPlanAsync(tenantId: UUID, id: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a production plan
ProductionPlansAPI.patchProductionPlanAsync(tenantId: tenantId, id: id, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
