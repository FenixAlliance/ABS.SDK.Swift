//
// ItemShippingPolicyUpdateDto.swift
//
...
public struct ItemShippingPolicyUpdateDto: Codable, JSONEncodable, Hashable {
    ...
    public init(title: String, description: String? = nil, type: String, code: String, isExpressShipmentPolicy: Bool? = nil, isFree: Bool? = nil, reduce: Bool? = nil, isEnabled: Bool? = nil, isDefault: Bool? = nil, allowInternational: Bool? = nil, hours: Int? = nil, days: Int? = nil, weeks: Int? = nil, months: Int? = nil, years: Int? = nil, value: Double? = nil, percentage: Double? = nil, currencyID: String, countryID: String? = nil, countryStateID: String? = nil, customState: String? = nil, customCity: String? = nil, cityID: String? = nil, shippingCourierID: String) {
        self.title = title
