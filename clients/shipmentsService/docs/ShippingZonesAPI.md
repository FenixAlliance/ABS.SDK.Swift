...
```swift
    open class func getShippingZonesAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, shippingZoneDtoCollectionQueryParameters: ShippingZoneDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ShippingZoneDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let shippingZoneDtoCollectionQueryParameters = ShippingZoneDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ShippingZoneDtoCollectionQueryParameters |  (optional)

// Get all shipping zones
ShippingZonesAPI.getShippingZonesAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, shippingZoneDtoCollectionQueryParameters: shippingZoneDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getShippingZonesCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, shippingZoneDtoCollectionQueryParameters: ShippingZoneDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get shipping zones count
ShippingZonesAPI.getShippingZonesCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, shippingZoneDtoCollectionQueryParameters: shippingZoneDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchShippingZoneAsync(tenantId: UUID, zoneId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a shipping zone
ShippingZonesAPI.patchShippingZoneAsync(tenantId: tenantId, zoneId: zoneId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
