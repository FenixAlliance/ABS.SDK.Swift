...
```swift
    open class func getShippingRegionsAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, shippingRegionDtoCollectionQueryParameters: ShippingRegionDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: ShippingRegionDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let shippingRegionDtoCollectionQueryParameters = ShippingRegionDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // ShippingRegionDtoCollectionQueryParameters |  (optional)

// Get all shipping regions
ShippingRegionsAPI.getShippingRegionsAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, shippingRegionDtoCollectionQueryParameters: shippingRegionDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getShippingRegionsCountAsync(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, shippingRegionDtoCollectionQueryParameters: ShippingRegionDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get shipping regions count
ShippingRegionsAPI.getShippingRegionsCountAsync(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, shippingRegionDtoCollectionQueryParameters: shippingRegionDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchShippingRegionAsync(tenantId: UUID, regionId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a shipping region
ShippingRegionsAPI.patchShippingRegionAsync(tenantId: tenantId, regionId: regionId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
