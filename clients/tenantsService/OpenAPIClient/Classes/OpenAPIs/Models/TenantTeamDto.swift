...
public struct TenantTeamDto: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, timestamp: Date? = nil, businessID: String? = nil, businessProfileRecordID: String? = nil, name: String? = nil, description: String? = nil, avatarURL: String? = nil, isPublic: Bool? = nil, businessUnitID: String? = nil, organizationProfileID: String? = nil) {
        self.id = id
