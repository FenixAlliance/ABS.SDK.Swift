//
// TenantDepartmentDtoListEnvelope.swift
//
...
public struct TenantDepartmentDtoListEnvelope: Codable, JSONEncodable, Hashable {
    ...
    public var result: [TenantDepartmentDto]?

    public init(isSuccess: Bool? = nil, errorMessage: String? = nil, correlationId: String? = nil, timestamp: Date? = nil, httpStatus: Int? = nil, errorCode: String? = nil, validationDetails: [String: [String]]? = nil, activityId: String? = nil, result: [TenantDepartmentDto]? = nil) {
