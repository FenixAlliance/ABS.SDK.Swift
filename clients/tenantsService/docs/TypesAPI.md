...
# **getTenantTypes**
```swift
    open class func getTenantTypes(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantTypeDtoCollectionQueryParameters: TenantTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: TenantTypeDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let tenantTypeDtoCollectionQueryParameters = TenantTypeDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // TenantTypeDtoCollectionQueryParameters |  (optional)

// Retrieve a list of tenant types
TypesAPI.getTenantTypes(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantTypeDtoCollectionQueryParameters: tenantTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getTenantTypesCount**
```swift
    open class func getTenantTypesCount(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantTypeDtoCollectionQueryParameters: TenantTypeDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get the count of tenant types
TypesAPI.getTenantTypesCount(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantTypeDtoCollectionQueryParameters: tenantTypeDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchTenantType**
```swift
    open class func patchTenantType(tenantId: UUID, tenantTypeId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a tenant type
TypesAPI.patchTenantType(tenantId: tenantId, tenantTypeId: tenantTypeId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
