...
let tenantSegmentCreateDto = TenantSegmentCreateDto(id: 123, timestamp: Date(), minEmployees: 123, maxEmployees: 123) // TenantSegmentCreateDto |  (optional)
...
# **getTenantSegments**
```swift
    open class func getTenantSegments(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantSegmentDtoCollectionQueryParameters: TenantSegmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: TenantSegmentDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let tenantSegmentDtoCollectionQueryParameters = TenantSegmentDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // TenantSegmentDtoCollectionQueryParameters |  (optional)

// Retrieve a list of tenant segments
SegmentsAPI.getTenantSegments(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantSegmentDtoCollectionQueryParameters: tenantSegmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTenantSegmentsCount(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantSegmentDtoCollectionQueryParameters: TenantSegmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get the count of tenant segments
SegmentsAPI.getTenantSegmentsCount(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantSegmentDtoCollectionQueryParameters: tenantSegmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchTenantSegment**
```swift
    open class func patchTenantSegment(tenantId: UUID, tenantSegmentId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a tenant segment
SegmentsAPI.patchTenantSegment(tenantId: tenantId, tenantSegmentId: tenantSegmentId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let tenantSegmentUpdateDto = TenantSegmentUpdateDto(minEmployees: 123, maxEmployees: 123) // TenantSegmentUpdateDto |  (optional)
