...
```swift
    open class func getTenantTeamContactEnrollments(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantTeamContactEnrollmentDtoCollectionQueryParameters: TenantTeamContactEnrollmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: TenantTeamContactEnrollmentDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let tenantTeamContactEnrollmentDtoCollectionQueryParameters = TenantTeamContactEnrollmentDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // TenantTeamContactEnrollmentDtoCollectionQueryParameters |  (optional)

// Retrieve a list of tenant team contact enrollments
TeamContactEnrollmentsAPI.getTenantTeamContactEnrollments(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantTeamContactEnrollmentDtoCollectionQueryParameters: tenantTeamContactEnrollmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTenantTeamContactEnrollmentsCount(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantTeamContactEnrollmentDtoCollectionQueryParameters: TenantTeamContactEnrollmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get the count of tenant team contact enrollments
TeamContactEnrollmentsAPI.getTenantTeamContactEnrollmentsCount(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantTeamContactEnrollmentDtoCollectionQueryParameters: tenantTeamContactEnrollmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchTenantTeamContactEnrollment(tenantId: UUID, tenantTeamContactEnrollmentId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a tenant team contact enrollment
TeamContactEnrollmentsAPI.patchTenantTeamContactEnrollment(tenantId: tenantId, tenantTeamContactEnrollmentId: tenantTeamContactEnrollmentId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
