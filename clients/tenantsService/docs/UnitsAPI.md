...
# **getTenantUnits**
```swift
    open class func getTenantUnits(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantUnitDtoCollectionQueryParameters: TenantUnitDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: TenantUnitDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let tenantUnitDtoCollectionQueryParameters = TenantUnitDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // TenantUnitDtoCollectionQueryParameters |  (optional)

// Retrieve a list of tenant units
UnitsAPI.getTenantUnits(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantUnitDtoCollectionQueryParameters: tenantUnitDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getTenantUnitsCount**
```swift
    open class func getTenantUnitsCount(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantUnitDtoCollectionQueryParameters: TenantUnitDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get the count of tenant units
UnitsAPI.getTenantUnitsCount(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantUnitDtoCollectionQueryParameters: tenantUnitDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **patchTenantUnit**
```swift
    open class func patchTenantUnit(tenantId: UUID, tenantUnitId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a tenant unit
UnitsAPI.patchTenantUnit(tenantId: tenantId, tenantUnitId: tenantUnitId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
