...
# **getTenantIndustries**
```swift
    open class func getTenantIndustries(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantIndustryDtoCollectionQueryParameters: TenantIndustryDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: TenantIndustryDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let tenantIndustryDtoCollectionQueryParameters = TenantIndustryDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // TenantIndustryDtoCollectionQueryParameters |  (optional)

// Retrieve a list of tenant industries
IndustriesAPI.getTenantIndustries(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantIndustryDtoCollectionQueryParameters: tenantIndustryDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTenantIndustriesCount(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantIndustryDtoCollectionQueryParameters: TenantIndustryDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get the count of tenant industries
IndustriesAPI.getTenantIndustriesCount(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantIndustryDtoCollectionQueryParameters: tenantIndustryDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchTenantIndustryAsync(tenantId: UUID, tenantIndustryId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a tenant industry
IndustriesAPI.patchTenantIndustryAsync(tenantId: tenantId, tenantIndustryId: tenantIndustryId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
