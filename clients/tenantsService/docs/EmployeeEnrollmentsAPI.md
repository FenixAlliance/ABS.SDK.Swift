...
```swift
    open class func getTenantEmployeeEnrollments(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantTeamEmployeeEnrollmentDtoCollectionQueryParameters: TenantTeamEmployeeEnrollmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: TenantTeamEmployeeEnrollmentDtoListEnvelope?, _ error: Error?) -> Void)
```
...
let apiVersion = "apiVersion_example" // String |  (optional)
let xApiVersion = "xApiVersion_example" // String |  (optional)
let tenantTeamEmployeeEnrollmentDtoCollectionQueryParameters = TenantTeamEmployeeEnrollmentDtoCollectionQueryParameters(top: 123, skip: 123, count: false, filter: "filter_example", orderBy: "orderBy_example", search: "search_example", select: "select_example", expand: "expand_example", isEmpty: false) // TenantTeamEmployeeEnrollmentDtoCollectionQueryParameters |  (optional)

// Retrieve a list of tenant employee enrollments
EmployeeEnrollmentsAPI.getTenantEmployeeEnrollments(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantTeamEmployeeEnrollmentDtoCollectionQueryParameters: tenantTeamEmployeeEnrollmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTenantEmployeeEnrollmentsCount(tenantId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, tenantTeamEmployeeEnrollmentDtoCollectionQueryParameters: TenantTeamEmployeeEnrollmentDtoCollectionQueryParameters? = nil, completion: @escaping (_ data: Int32Envelope?, _ error: Error?) -> Void)
```
...
// Get the count of tenant employee enrollments
EmployeeEnrollmentsAPI.getTenantEmployeeEnrollmentsCount(tenantId: tenantId, apiVersion: apiVersion, xApiVersion: xApiVersion, tenantTeamEmployeeEnrollmentDtoCollectionQueryParameters: tenantTeamEmployeeEnrollmentDtoCollectionQueryParameters) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func patchTenantEmployeeEnrollmentAsync(tenantId: UUID, tenantEmployeeEnrollmentId: UUID, apiVersion: String? = nil, xApiVersion: String? = nil, patchOperation: [PatchOperation]? = nil, completion: @escaping (_ data: EmptyEnvelope?, _ error: Error?) -> Void)
```
...
// Patch a tenant employee enrollment
EmployeeEnrollmentsAPI.patchTenantEmployeeEnrollmentAsync(tenantId: tenantId, tenantEmployeeEnrollmentId: tenantEmployeeEnrollmentId, apiVersion: apiVersion, xApiVersion: xApiVersion, patchOperation: patchOperation) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
